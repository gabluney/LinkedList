...
class List
{
 ...
 private:
     LNode * Head;
     //Helper Methods
     void PrintHelper(LNode *head);
     bool InsertTailHelper(LNode * &head, float value);
     bool SearchHelper(LNode *head, float value);
     bool DeleteHelper(LNode* &curr, LNode* &prev, float value);
     void DestroyHelper(LNode *head);
